...
const heroInner: Record<string, string> = {
  "rose-plum":
    "bg-gradient-to-br from-[hsl(350,42%,96%)] via-[hsl(300,18%,97%)] to-[hsl(280,20%,93%)] text-charcoal",
  "cream-mauve":
    "bg-gradient-to-br from-[hsl(35,38%,97%)] via-[hsl(310,16%,96%)] to-[hsl(280,14%,93%)] text-charcoal",
  dusk: "bg-gradient-to-br from-[hsl(260,18%,94%)] via-[hsl(290,16%,93%)] to-[hsl(330,22%,92%)] text-charcoal",
  sleep:
    "bg-gradient-to-br from-[hsl(240,24%,20%)] via-[hsl(280,18%,24%)] to-[hsl(310,20%,22%)] text-white/95",
};
  ...
  return (
    <div
      className={cn(
        ...
        isSleep ? "border-white/10 bg-gradient-to-br from-white/15 to-transparent" : "border-border/40 bg-gradient-to-br from-white/50 to-border/20"
      )}
    >
